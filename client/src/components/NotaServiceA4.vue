...
const props = defineProps({
  ...
  // Set true by the parent right before an html2canvas capture, to hide the
  // interactive password-reveal toggle from the captured image/PDF.
...
const receivedTime = computed(() => `${new Intl.DateTimeFormat('id-ID', { hour: '2-digit', minute: '2-digit' }).format(new Date(props.service.received_at))} WIB`);
